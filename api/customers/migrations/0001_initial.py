# Generated by Django 4.1.1 on 2022-11-12 11:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[(1, 'Male'), (2, 'Female'), (3, 'Secret')], default=3, verbose_name='gender of customer')),
                ('date_of_birth', models.DateField(null=True, verbose_name='customer date of birth')),
                ('is_newsletter_enabled', models.BooleanField(default=True, verbose_name='newsletter enabled')),
                ('user', models.OneToOneField(limit_choices_to={'user_type': 3}, on_delete=django.db.models.deletion.CASCADE, related_name='related_customer', to=settings.AUTH_USER_MODEL, verbose_name='customer profile of')),
            ],
            options={
                'ordering': ['-created_at'],
            },
