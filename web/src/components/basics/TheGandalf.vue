...
.wizard .wizard-step.is-visited:not(.is-current, .is-completed) .wizard-step-counter:after {
	background-color: var(--wizard-step);
...
.wizard .wizard-step:is(.is-completed):not(.is-current) .wizard-step-counter:after {
	background-color: var(--wizard-step);
	background-size: 0.55rem;
