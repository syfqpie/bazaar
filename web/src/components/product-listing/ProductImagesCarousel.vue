		...
		<button
			...
			<span
				class="inline-flex items-center justify-center
                 ...
                 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 
                 group-focus:outline-none">
				<i class="fa-solid fa-circle-chevron-right text-lg"></i>
...
import type { ProductListingImage } from '@/common/models/product-listing.model'
export default defineComponent({
    ...
    props: {
        images: {
            type: Object as () => ProductListingImage[],
            required: true
        },
