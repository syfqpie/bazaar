<template>
    <footer class="bg-neutral-100 rounded-lg shadow px-4 py-4 md:py-8 lg:px-32">
        <div class="flex flex-col sm:flex-row items-center sm:justify-between">
            ...
            <ul class="flex flex-wrap items-center mb-2 text-sm text-gray-500 sm:mb-0">
                <li>
                    <a href="https://github.com/syfqpie/bazaar"
...
export default defineComponent({
    ...
    setup() {
        onMounted(() => {
            // console.log('Mounted GeneralFooter')
        })
