                            ...
                            <ul class="space-y-2">
                                <li>
                                    <button
                                        ...
                                        <i 
                                            class="fa-solid transition duration-1000"
                                            :class="{
                                                'fa-chevron-right': !isAccountMenuActive ||
                                                                    !$route.path.startsWith(ACCOUNT_PATH),
                                                'fa-chevron-down': isAccountMenuActive ||
                                                                    $route.path.startsWith(ACCOUNT_PATH)
                                            }"></i>
                                    </button>
